...
public interface RecommendContract {
    abstract class RecommendPresenter extends BasePresenter<IRecommendModel,IRecommendView>{
        public abstract void getData();
        public abstract void onItemClick(int position, RecommendBean bean,Context context);
    }
