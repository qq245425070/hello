...
public class RecommendFragment extends BaseRecycleFragment<RecommendContract.RecommendPersenter,RecommendContract.IRecommendModel> implements RecommendContract.IRecommendView {
    ...
    public void setAdapter( List<RecommendBean> beanList) {
        ...
        mAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                mPresenter.onItemClick(position,mBeanList.get(position));
            }
        });
    }
