...
public class GiftPopWindow extends PopupWindow implements View.OnClickListener{
    ...
    public GiftPopWindow(Context context,PropBeanList propBeanList,LiveMessageFragment fragment,String userId,String programId){
        ...
        mRoot = inflater.inflate(R.layout.gift_pop_window,null);
        ...
        Recharge = (Button) mRoot.findViewById(R.id.recharge);
    ...
    private void giveGiftAcoin(String type,String propName){
        ...
        GiveGiftUtil.giveGiftAcoin(type, mUserID, fragment, mCount / 100, propName, mProgramID, mPropImg);
        if(this.isShowing()){
            this.dismiss();
        }
    }
    private void giveGiftJinjiao(String propid,String propName){
        ...
        GiveGiftUtil.giveGiftJinjao(propid, mUserID, fragment, mCount / 100, propName, mProgramID, mPropImg);
        if(this.isShowing()){
            this.dismiss();
        }
    }
