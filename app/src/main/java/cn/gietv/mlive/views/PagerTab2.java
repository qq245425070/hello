...
public class PagerTab2 extends ViewGroup {
	...
	private int mDividerWidth = 2;// 分割线的宽度
	private int mDividerColor = 0xFF4fc396;//分割线颜色
	...
	private void init() {
		//把一个值从dip转换成px
		mIndicatorHeight = DensityUtil.dip2px(mActivity , mIndicatorHeight);
		mDividerPadding = DensityUtil.dip2px(mActivity , mDividerPadding);
		mTabPadding = DensityUtil.dip2px(mActivity , mTabPadding);
		mDividerWidth = DensityUtil.dip2px(mActivity , mDividerWidth);
		mTabTextSize = DensityUtil.dip2px(mActivity , mTabTextSize);
		//创建一个scroller
