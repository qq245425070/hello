 ...
 */
public class GameListFragment3 extends AbsBaseFragment{
    ...
    public static GameListFragment3 getCategoryFragment(String type){
        GameListFragment3 fragment = new GameListFragment3();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mCurrentView = inflater.inflate(R.layout.fragment_games, null);
        HeadViewController.initSearchHeadWithoutReturn(mCurrentView,getActivity(),"游戏");
