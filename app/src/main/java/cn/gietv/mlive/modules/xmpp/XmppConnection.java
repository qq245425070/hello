...
public class XmppConnection {
    ...
    private String SERVER_HOST = ConfigUtils.CHAT_SERVER;
    private XMPPConnection connection = null;
    private String SERVER_NAME =  ConfigUtils.CHAT_SERVER;
    ...
    public boolean openConnection() {
        ...
        try {
            if (null == connection || !connection.isAuthenticated()) {
                ...
                config.setCompressionEnabled(false);// 是否启用安全验证
//                config.setTruststorePath("/system/etc/security/cacerts.bks");
//                config.setTruststorePassword("changeit");
//                config.setTruststoreType("bks");
                connection = new XMPPConnection(config);
                    Log.e("XmppConnection",connection.toString());
    ...
    public boolean login(String account, String password) {
        try {
            ...
            getConnection().login(account, password,ConfigUtils.COME_SOURSE);
            // 更改在綫狀態
