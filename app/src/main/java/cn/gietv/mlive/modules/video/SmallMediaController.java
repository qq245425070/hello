package cn.gietv.mlive.modules.video;

/**
 * author：steven
 * datetime：15/10/12 10:00
 */
public class SmallMediaController{//} extends MediaController {
...
//
//    private boolean mIsShowFullImage = true;
//
//    public void setOnFullScreenListener(View.OnClickListener onFullScreenListener) {
...
//    }
//
//    public SmallMediaController(Context context, boolean fromXml, View container) {
//        super(context);
//        initController(context);
//        mFromXml = fromXml;
//        mRoot = makeControllerView();
//        //这个地方的FrameLayout.LayoutpParams是因为布局文件中要把MediaController的视图作为childView加到一个FrameLayout中去
//        FrameLayout.LayoutParams p = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.FILL_PARENT, FrameLayout.LayoutParams.WRAP_CONTENT);//想怎样布局MediaController就尽情的发挥这个LayoutParams吧
...
//        params.height = DensityUtil.dip2px(v.getContext(), 48);
...
//        mFullScreenImage = (ImageView) v.findViewById(getResources().getIdentifier("mediacontroller_full_screen", "id", mContext.getPackageName()));
//        if (mFullScreenImage != null && mOnFullScreenListener != null) {
//            mFullScreenImage.setOnClickListener(mOnFullScreenListener);
//        }
//        mFullScreenImage.setVisibility(mIsShowFullImage ? View.VISIBLE : View.GONE);
//    }
//
//    public void setIsShowFullImage(boolean isShowFullImage) {
