...
public class SurfaceRenderView extends SurfaceView implements IRenderView {
    ...
    public SurfaceRenderView(Context context,IRenderView.IRenderCallback mSHCallback) {
        super(context);
        ...
        mSurfaceCallback.addRenderCallback(mSHCallback);
    }
